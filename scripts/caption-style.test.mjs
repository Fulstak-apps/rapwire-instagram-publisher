...
test('queue migration rebuilds only safely unpublished parent containers',()=>{
 const item={status:'ready',source_handle:'akademiks',source_url:'https://www.instagram.com/p/abc/',source_caption_text:'New album announced.',caption_source_shortcode:'abc',caption_policy:'exact-source-v1',vip_source_checked:true,
 ...
 assert.equal(item.caption,'old caption\n\n@rapwire247');
